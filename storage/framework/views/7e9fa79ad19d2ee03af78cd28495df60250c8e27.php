...
<?php $__env->startSection('cont'); ?>
    ...
    <head>
        ...
        />
        <!-- Custom CSS -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/FAQstyle.css')); ?>">
    </head>
...
<?php echo $__env->make('layouts.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project-file\resources\views/FAQ.blade.php ENDPATH**/ ?>